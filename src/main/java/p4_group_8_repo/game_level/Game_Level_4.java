...
public class Game_Level_4 extends Game_Pane  {

	public Game_Level_4(User user)  throws FileNotFoundException {
		super(user);
	
		add(new Obstacle(50, 485, -1.5, "car_2","left"));		//forth_layer_traffic
		add(new Obstacle(150, 485, -1.5, "car_2","left"));
		add(new Obstacle(300, 485, -1.5, "car_2","left"));
		add(new Obstacle(450, 485, -1.5, "car_2","left"));

		add(new Obstacle(0, 535, 2, "car_1","right"));			//third_layer_traffic
		add(new Obstacle(100, 535, 2, "car_1","right"));
		add(new Obstacle(200, 535, 2, "car_1","right"));
		add(new Obstacle(450, 535, 2, "car_1","right"));
		add(new Obstacle(550, 535, 2, "car_1","right"));	
		
		add(new Obstacle(0, 565, -1.3, "truck_1","left"));		//second_layer_traffic
		add(new Obstacle(500, 565, -1.3, "truck_1","left"));
		add(new Obstacle(820, 565, -1.3, "truck_1","left"));
		
		add(new Obstacle(100, 617, -1.1, "truck_2","left"));	//first_layer_traffic
		add(new Obstacle(500, 617, -1.1, "truck_2","left"));
