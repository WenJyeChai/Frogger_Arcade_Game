...
public class Game_Level_5 extends Game_Pane {

	public Game_Level_5(User user) throws FileNotFoundException {
		super(user);

		add(new Obstacle(50, 485, -1.7, "car_1","left"));			//forth_layer_traffic
		add(new Obstacle(150, 485, -1.7, "car_1","left"));
		add(new Obstacle(300, 485, -1.7, "car_1","left"));
		
		add(new Obstacle(0, 535, 1.8, "car_2","right"));			//third_layer_traffic
		add(new Obstacle(100, 535, 1.8, "car_2","right"));
		add(new Obstacle(250, 535, 1.8, "car_2","right"));
		add(new Obstacle(400, 535, 1.8, "car_2","right"));
		add(new Obstacle(550, 535, 1.8, "car_2","right"));
		
		add(new Obstacle(0, 565, -1.5, "truck_1","left"));			//second_layer_traffic
		add(new Obstacle(190, 565, -1.5, "truck_1","left"));
		add(new Obstacle(520, 565, -1.5, "truck_1","left"));
		
		add(new Obstacle(100, 617, -1.3, "truck_2","left"));		//first_layer_traffic
		add(new Obstacle(500, 617, -1.3, "truck_2","left"));
